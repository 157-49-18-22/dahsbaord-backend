...
async function test() {
  ...
  console.log('Testing template preview WITH TRAILING SLASH...');
  console.log('URL:', `${apiURL}/message-template-preview/`);
  
  try {
    const res = await axios.post(`${apiURL}/message-template-preview/`, {
